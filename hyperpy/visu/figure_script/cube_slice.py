...
p.image(image='image',source=source, x=0, y=0, dw=cube_show.shape[0], dh=cube_show.shape[1], palette="Spectral11", level="image")
p.grid.grid_line_width = 0.5

slider = Slider(start=0, end=cube_show.shape[2]-1, step=1, value=init_slice, title='Index')
